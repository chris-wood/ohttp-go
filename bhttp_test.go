...
func TestTruncation(t *testing.T) {
	...
	// This request has valid truncation since it has no content or trailers and truncates both
	encodedRequest, err := hex.DecodeString("")
	require.Nil(t, err)
	binaryRequest, err := UnmarshalBinaryRequest(encodedRequest)
	require.Nil(t, err)
	require.Equal(t, int(binaryRequest.ContentLength), 0)

	// This request has valid truncation since it has content (4 bytes of 'b','o','d','y') but truncated trailers
	encodedRequest, err = hex.DecodeString("")
	require.Nil(t, err)
	binaryRequest, err = UnmarshalBinaryRequest(encodedRequest)
	require.Nil(t, err)
	require.Equal(t, int(binaryRequest.ContentLength), 4)

	// This request has invalid truncation since it just drops the trailing length fields entirely
	encodedRequest, err = hex.DecodeString("")
	require.Nil(t, err)
	_, err = UnmarshalBinaryRequest(encodedRequest)
	require.NotNil(t, err)

	// This request has invalid truncation since it truncates the content but not the trailers
	encodedRequest, err = hex.DecodeString("")
	require.Nil(t, err)
	_, err = UnmarshalBinaryRequest(encodedRequest)
	require.NotNil(t, err)
}
